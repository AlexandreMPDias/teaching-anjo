...
const inputStyleConfig: ComponentMultiStyleConfig = {
	parts: parts.keys,
	sizes,
	variants,
	defaultProps,
	baseStyle: {
		...
		field: {
			...
			_focus: {
				color: colors.keys.secondary_400,
				boxShadow: `0 0 0 1px ${colors.keys.primary_400}`,
			},
			_disabled: {
				color: colors.keys.neutral_300,
			},
			_hover: {
				cursor: 'text',
			},
